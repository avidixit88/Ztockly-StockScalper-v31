...
st.markdown(
    """
    <style>
      .block-container { max-width: 100% !important; padding-left: 1.25rem; padding-right: 1.25rem; }
...
capture_alerts = st.sidebar.toggle(
    ...
    value=True,
    help="Stores alerts inside the app. Streamlit must be open to run scans/alerts (no background execution).",
)
